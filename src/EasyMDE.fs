...
module EasyMDE =
    ...
    type Options =
        ...
        abstract autoRefresh: U2<bool, OptionsAutoRefresh> option with get, set
        ...
        abstract lineNumbers: bool option with get, set
        ...
        abstract previewImagesInEditor: bool option with get, set
        ...
        abstract sideBySideFullscreen: bool option with get, set
        ...
        abstract overlayMode: OverlayModeOptions option with get, set

    [<AllowNullLiteral>]
    type OptionsAutoRefresh =
...
type EasyMDEStatic =
    ...
    abstract drawUploadedImage: (EasyMDE -> unit) with get, set
